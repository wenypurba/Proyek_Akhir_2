<main id="main">
		<div class="container">
					...
					@foreach ($sliders as $slide)
						<div class="item-slide">
							...
							<div class="slide-info slide-1">
								...
								<p class="sale-info">Harga: <span class="price">Rp.{{$slide->price}}</span></p>
			...
			<!--On Sale-->
			@if($sproducts->count() > 0  && ($sale!=null)?  $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now():'' )
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box">Promo</h3>
				<div class="wrap-countdown mercado-countdown" data-expire="{{ ($sale!=null)? Carbon\Carbon::parse($sale->sale_date)->format('Y/m/d h:m:s') :''}}"></div>
					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							...
							<div class="group-flash">
								<span class="flash-item sale-label">Dijual</span>
							</div>
						</div>
										...
										<div class="product product-style-2 equal-elem ">
											...
											<div class="product-info">
												<a href="{{route('product.details',['slug'=>$c_product->slug])}}" class="product-name"><span>{{$c_product->name}}</span></a>
													<div class="wrap-price"><span class="product-price">Rp.{{$c_product->regular_price}}</span>
												</div>
											</div>
										</div>
										@endforeach
