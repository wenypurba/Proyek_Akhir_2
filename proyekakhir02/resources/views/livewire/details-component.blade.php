    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            <div class="wrap-product-detail">
                ...
                <div class="detail-info">
                    ...
                    @if($product->sale_price > 0  && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                        <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->sale_price}})">Tambahkan ke Keranjang</a>
                    @else
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content-item " id="review">
                            ...
                            <style>
                                ...
                                <div id="comments">
                                    <h2 class="woocommerce-Reviews-title">{{$product->orderItems->where('rstatus',1)->count()}} review untuk <span>{{$product->name}}</span></h2>
                                            ...
                                            <div id="comment-20" class="comment_container"> 
                                                ...
                                                <div class="comment-text">
                                                    <div class="star-rating">
                                                        <span class="width-{{  $orderItem->review->rating * 20 }}-percent">Rated <strong class="rating">{{$orderItem->review->rating}}</strong> dari 5</span>
                                                    </div>
                                                    <p class="meta"> 
                    ...
                    <ul class="our-services">
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    ...
                                    <span class="subtitle">Aman Sampai Tujuan</span>
                                    <p class="desc">Transaksi cepat dan aman</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    <b class="title">Barang Berkualitas</b>
                                    <span class="subtitle">Terjamin 100%!</span>
                                    <p class="desc">Barang sesuai harapan</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    <b class="title">Garansi</b>
                                    <span class="subtitle">Barang bergaransi</span>
                                    <p class="desc">Jaminan barang</p>
                                </div>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="wrap-show-advance-info-box style-1 box-in-site">
                <h3 class="title-box">Barang Terkait</h3>
