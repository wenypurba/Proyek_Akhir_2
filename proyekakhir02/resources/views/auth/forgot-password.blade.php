...
<div class="container">
    ...
    <div class="wrap-breadcrumb">
        <ul>
            ...
            <li class="item-link"><span>Lupa Password</span></li>
        </ul>
    </div>
    <div class="row">
                    ...
                    <x-jet-validation-errors class="mb-4" />
                        <form name="frm-login" method="POST" action="{{route('password.email')}}">
                            ...
                            <fieldset class="wrap-input">
                                ...
                                <input type="email" id="frm-login-uname" name="email" placeholder="Masukkan alamat e-mail anda" :value="old('email')" required autofocus>
                            </fieldset> 
